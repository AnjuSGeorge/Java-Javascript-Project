...
<%
String LeagueNameId= (String)request.getAttribute("LeagueNameId");
System.out.println("Leaguename id in jsp"+LeagueNameId);
String[] words=LeagueNameId.split("_");//splits the string based on _  
//using java foreach loop to print elements of string array  
String LeagueName = words[0];
String LeagueId= words[1];
...
<section class="content">
	...
	<form role="form" class="form-element" method="post" action="../createMyTeam">
	<div class="box-body">
      <div class="form-group">
    <label for="TeamName">Team Name: </label>
		<input required type="text" name="teamName" id="teamName"><br><br>
