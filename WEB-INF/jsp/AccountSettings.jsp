      ...
      <div class="row">
        ...
        <div class="col-xl-8 col-lg-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" class="form-element" action="./AccountSettings.html" method="post" onsubmit="return ValidateUpdateUser()" id="AcctSettingsfrm" enctype="multipart/form-data">
             
              <div class="box-body">
                <div class="form-group">
                  <label for="email">Email Address</label>
                  <input type="email" class="form-control" id="email" value='<%=session.getAttribute("Emailid")%>' disabled>
                </div>
                <div class="form-group">
                  <label for="username">Username</label>
                  <input type="email" class="form-control" id="username" value='<%=session.getAttribute("username")%>' disabled>
                </div>
                <div class="form-group">
