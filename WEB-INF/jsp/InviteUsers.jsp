  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="image">
          <img src='<%=session.getAttribute("pic")%>' class="rounded-circle" alt="User Image">
        </div>
        <div class="info">
...
int LeagueId=0;
String League="";
if (request.getAttribute("LeagueId") != null)
{
 LeagueId=(int)request.getAttribute("LeagueId");
}
if (request.getParameter("LeagueId") != null)
{
	League=(String)request.getParameter("LeagueId");
 System.out.println("League "+League);
 LeagueId= Integer.parseInt(League);
...
%>
	...
	<h1> Invite people to play in League </h1>
	...
	<form role="form" class="form-element" method="post" action="./sendInvite" id="inviteToPlayfrm">
	<div class="box-body">
      <div class="form-group">
    
	<label for="EmailAddress">Email Address: </label>
		<input required  class="form-control" type="text" name="EmailAdd" id="EmailAdd" size = "100" title="Email addresses separated by commas"><br><br>
