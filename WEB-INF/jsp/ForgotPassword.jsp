            ...
            <div id="loginbox" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                <div class="panel white-alpha-90" >
                    ...
                    <div class="panel-body" >
                        ...
                        <form class="form-horizontal" role="form" action="./ForgotPassword.html" method="post" id="resetPasswordForm">
                           
							


                            <div class="form-group">
                                <label class="col-md-4 control-label">Enter your registered email address:
							</label>
						...
						<div class="col-md-12">
							 <div class="form-group">
                                <div class="col-md-6 col-md-offset-4">
									<br><br>
                                    <button type="submit" class="btn btn-primary lg-btn"  onclick="checkUserExists()" >
                                       Reset 
                                    </button>
