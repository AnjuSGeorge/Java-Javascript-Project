            ...
            <div id="loginbox" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                <div class="panel white-alpha-90" >
                    ...
                    <div class="panel-body" >
                        ...
                        <form class="form-horizontal" role="form" action="./register.html" method="post" onsubmit="return validateRegister()">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input class="form-control" type="text" name="username" id="uname" value='<%=request.getParameter("username") == null ? "" : request.getParameter("username")%>'/>
        ...
        <nav class="navbar navbar-default navbar-fixed-bottom" role="navigation">
            <div class="container text-center">
                <div class="footer-content" style="color:#d7d7d7;">
                    Existing User?  <a href="./login.html" class="btn btn-primary lg-btn" style="width:130px;"> Login </a>
                </div>
            </div><!-- /.container-fluid -->
        </nav>
    </footer>
